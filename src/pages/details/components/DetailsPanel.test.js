...
describe('Country details panel', () => {
  it('renders the flag', () => {
    const root = render(<DetailsPanel country={bra} />);
  ...
  it('displays a placeholder if the capital name is not available', () => {
    const root = render(<DetailsPanel country={{ ...bra, capital: null }} />);
  ...
  it('displays a comma separated list of the top level domains', () => {
    ...
    const root = render(<DetailsPanel country={{ ...bra, topLevelDomains }} />);
